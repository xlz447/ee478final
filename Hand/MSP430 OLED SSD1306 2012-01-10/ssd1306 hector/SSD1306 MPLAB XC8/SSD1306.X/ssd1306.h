...
//------------------------------------------------------------------------------
#define OLED_CS            LATDbits.LATD0
#define TRIS_CS            TRISDbits.TRISD0

#define OLED_DC            LATDbits.LATD1
#define TRIS_DC            TRISDbits.TRISD1

#define OLED_RES           LATDbits.LATD2
#define TRIS_RES           TRISDbits.TRISD2
//------------------------------------------------------------------------------
